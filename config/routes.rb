Rsense::Application.routes.draw do
  ...
  get '/data_sets/:id/spreadsheet' => 'data_sets#spreadsheet'
  put '/data_sets/:id/spreadsheet' => 'data_sets#spreadsheet'
  post '/data_sets/:id/spreadsheet' => 'data_sets#spreadsheet'
